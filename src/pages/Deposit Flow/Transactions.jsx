            ...
            <div className="px-48 flex justify-between">
                <div className=" w-1/2 p-5">
                    ...
                    <div className="mt-3 py-2 px-14 w-full">
                        ...
                        <Card2 mt={"my-8"} img={greenArrowDown} top={"Received 111.11BTC"} bottom={"From xxxxxxxxxxxxxxxxx"} />
                        <Card2 mt={"my-8"} img={greenArrowUp} top={"Sent 111.11BTC"} bottom={"From xxxxxxxxxxxxxxxxx"} />
                        <Card2 mt={"my-8"} img={greenArrowDown} top={"Received 111.11BTC"} bottom={"From xxxxxxxxxxxxxxxxx"} />
