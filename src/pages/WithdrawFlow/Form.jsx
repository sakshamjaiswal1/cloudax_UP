        ...
        <div className="bg-grey  ">
          <div className="p-5 pb-3 " >
              ...
              <div className="mt-1 relative">
                ...
                >
                  <span className="flex ">
                    ...
                    />
                    <span className="ml-3 block truncate text-black-700 font-[500] text-[14px] "> Select Bank </span>{" "}
            ...
            <div className="mt-6" >
              <label
                id="listbox-label"
                className="block text-black-700 font-[500] text-[14px]"
              >
                Account Number
              </label>
              <div className="mt-1 relative">
                <input
                  ...
                  className="relative w-full placeholder-gray-400 bg-white border border-black-300 rounded-md shadow-sm pl-3 pr-10 py-2 text-left cursor-default focus:outline-none focus:ring-1 focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"
                />
              </div>
            </div>
            <div className="mt-6" >
            ...
            <div className="mt-6 mb-6 relative justify-center ml-2 pl-0">
              ...
              <div className="mt-3 relative justify-center ml-3 pl-8">
                <button
                  type="button"
                  placeholder="0123456789"
                  className="text-gray-400 p-3 w-11/12 justify-center   border border-black-500 rounded-[26px] bg-white  pl-3  text-center"
                >
                  Verify BVN
                </button>
              </div>
