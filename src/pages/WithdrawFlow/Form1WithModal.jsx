                              ...
                              <div className="relative w-26 text-[9px]  flex justify-center bg-white rounded-2xl shadow-lg">
                                ...
                                <div className="flex justify-center flex-col h-[180px] w-[370px] ">
                                  {" "}
                                   ...
                                   <div className='flex justify-center items-center mr-5 flex-col'  ><p  className='text-black  font-[500] text-[12px] pt-4 pb-0 ml-10'  >Your BVN is being verified.  </p><p  className='  text-black font-[500] text-[12px]  pb-0 ml-10'>You will be notified as soon as it is approved.</p></div>
