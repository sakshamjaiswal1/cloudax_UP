...
const LoginNew = () => {
  return (
    <div className="flex lg:bg-[#F5F5F5] ip:bg-[white] justify-center items-cente w-full">
      ...
      <AiOutlineArrowLeft className="text-[#000000] text-[26px] lg:text-[30px] mb-[24px]" />
        <p className="text-[#000000] mb-[20px] font-[700] sm:text-[39.02px] leading-[51px] text-[24px]">
          Login to Cloudax
        </p>
      ...
      <input
        type="password"
        className="px-[6px]  pl-[30px] border-[1.29px] border-[#000000] rounded-[38px] h-[59px] w-[305px] lg:w-[486px] lg:h-[85px] relative bg-inherit  text-[#6F6F6F]  text-[16px]  lg:text-[21px] font-[400]"
      />
