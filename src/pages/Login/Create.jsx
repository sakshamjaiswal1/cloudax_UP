...
const Create = () => {
  return (
    ...
    <AiOutlineArrowLeft className="text-[#000000] text-[30px] mb-[24px]" />
      ...
      <label htmlFor="" className="text-[#393939] text-mn lg:text-[21px] py-[10px]">Your First Name</label>
      <input
        type="text"
      ...
      /> <label htmlFor="" className="text-[#393939] text-mn lg:text-[21px] py-[10px] font-[400]">Your Last Name</label>
      <input
        type="text"
      ...
      />
       <label htmlFor="" className="text-[#393939] text-mn lg:text-[21px] py-[10px]">Email</label>
      <input
        type="text"
     ...
     <div className="flex flex-col relative">
      ...
      <p className="text-[#393939] text-[16px] lg:text-[21px] font-[400] pl-[30px] lg:pl-[70px]">Already have a account <a href="text"className="text-[#28A9F1] underline" > Login</a></p>
    </div>
  </div>
  )
}
